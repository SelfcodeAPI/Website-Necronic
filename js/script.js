...
const config = {
    serverInfo: {
        ...
        serverName: "Necronic", /*Server name*/
        serverIp: "Necronic.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "774004070859800616" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    All skins for original players are generate automaticaly. If you want to add skins to warez players, yout must add url for skin to skinUrlOrPathToFile
        {
            inGameName: "NxtRevers",  <--- In-Game name
            rank: "Owner",  <-- rank
    ...
    */
    ...
    atGroupsDefaultColors: {
        owners: "rgb(109,14,37)",
        admins: "rgb(121,14,14)",
